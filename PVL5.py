...
class sech:
    ...
    осуществлен расчет продольных удельных сопротивлений прямой и обратной последовательностей,
    а также поперечной емкостной проводимости прямой и обратной последовательностей'''
